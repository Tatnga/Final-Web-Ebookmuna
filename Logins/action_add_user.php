...
if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
    ...
    echo "popup.document.write('<h1>Failed!</h1><p>Email invalid.</p>');";
    ...
    echo "var top = (screen.height / 2) - (200 / 2);";
    echo "var popup = window.open('', 'mypopup', 'width=400,height=200,left='+left+',top='+top);";
    echo "popup.document.write('<h1>Failed!</h1><p>Email already exists in database or Firebase Authentication.</p>');";
    echo "setTimeout(function() {";
    echo "window.location.replace('register.php');";
    echo "popup.close();";
    echo "}, 3000);";
    echo "</script>";
                ...
                if (strlen($_POST['password']) >= 6) {
                    ...
                    echo "var top = (screen.height / 2) - (200 / 2);";
                    echo "var popup = window.open('', 'mypopup', 'width=400,height=200,left='+left+',top='+top);";
                    echo "popup.document.write('<h1>Success!</h1><p>Account Registered.</p>');";
                    echo "setTimeout(function() {";
                    ...
                    echo "</script>";
                        ...
                        echo "var top = (screen.height / 2) - (200 / 2);";
                        echo "var popup = window.open('', 'mypopup', 'width=400,height=200,left='+left+',top='+top);";
                        echo "popup.document.write('<h1>Failed!</h1><p>Failed to add user.</p>');";
                        echo "setTimeout(function() {";
                        echo "window.location.replace('register.php');";
                        echo "popup.close();";
                        echo "}, 3000);";
