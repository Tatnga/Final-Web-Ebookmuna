...
<div class="form-container"style="background-color: wheat;">
   ...
   <form action="action_add_subjects.php" method="post" style="border: solid;">
      <img src="Ebook.png" width="150px">
      <h3 style="color:white;">ADD NEW Subjects</h3>
      <?php
      if(isset($error)){
      ...
      ?>
      <input type="text" name="name1" required placeholder="Enter New Subjects :">
